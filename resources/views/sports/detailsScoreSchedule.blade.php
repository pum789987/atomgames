...
@section('title','Atom Games | รายละเอียดผลการแข่งขัน')
...
@section('container')
        ...
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                @if($page == "S_update")
                    ...
                    <li class="breadcrumb-item active">รายละเอียดข้อมูลผลการแข่งขันกีฬา</li>
                @else
                    ...
                    <li class="breadcrumb-item active">รายละเอียดข้อมูลผลการแข่งขันกิจกรรมสัมพันธ์</li>
                @endif
            </ul>
        </div>
    </div>
    <section class="forms">
        <div class="container-fluid">
            <header>
                @if($page == "S_update")
                    <h1 class="h3 display">รายละเอียดข้อมูลผลการแข่งขันกีฬา</h1>
                @else
                    <h1 class="h3 display">รายละเอียดข้อมูลผลการแข่งขันกิจกรรมสัมพันธ์</h1>
                @endif
            </header>
            <div class="row mb-4">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tr class="bx-1">
                                    ...
                                    <th nowrap></th>
                                    <th nowrap>คะแนน</th>
                                    <th nowrap class="text-center">เหรียญ</th>
                                    <th nowrap class="text-center">ผลการคัดเลือก</th>
                                </tr>
                                </thead>
                                <tbody class="bb-1">
                                <tr class="bx-1">
                                    ...
                                    @if($data[$i]->CP_SCORE)
                                        <td class="bl-1 align-middle">{{$data[$i]->CP_SCORE}}</td>
                                    @else
                                        <td class="bl-1 align-middle">ไม่มีคะแนนการแข่ง</td>
                                    @endif

                                    @if($data[$i]->CP_MEDAL)
                                        @if($data[$i]->CP_MEDAL == "G")
                                            <td class="bl-1 align-middle text-center">ทอง</td>
                                        @elseif($data[$i]->CP_MEDAL == "S")
                                            <td class="bl-1 align-middle text-center">เงิน</td>
                                        @else
                                            <td class="bl-1 align-middle text-center">ทองแดง</td>
                                        @endif
                                    @else
                                        <td class="bl-1 align-middle text-center">ไม่มีเหรียญรางวัล</td>
                                    @endif

                                    @if($data[$i]->CP_STATUS)
                                        @if($data[$i]->CP_STATUS == "F")
                                            <td class="bl-1 align-middle text-center text-success">ผ่านเข้ารอบ</td>
                                        @elseif($data[$i]->CP_STATUS == "E")
                                            <td class="bl-1 align-middle text-center text-danger">ตกรอบ</td>
                                        @else
                                            <td class="bl-1 align-middle text-center text-success">เสมอ</td>
                                        @endif
                                    @else
                                        <td class="bl-1 align-middle text-center">ไม่มีสถานะ</td>
                                    @endif
                                </tr>
                                ...
                                @elseif($i != 0 && $data[$i]->CP_STATUS == "B")
                                    <tr class="bx-1">
                                        ...
                                        @else
                                            <td class="bl-1 align-middle text-center">ไม่มีเหรียญรางวัล</td>
                                        @endif
                                        <td class="bl-1 align-middle text-center text-success">ชนะผ่าน</td>
                                    </tr>
                                @endif
                                @endfor
                                <tr class="bt-1">
