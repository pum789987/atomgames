...
@section('title','Atom Games | ตารางการแข่งขัน')
...
@section('container')
    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                @if ($types_of_S== "sport")
                    <li class="breadcrumb-item active">ตารางการแข่งขันกีฬา</li>
                @else
                    <li class="breadcrumb-item active">ตารางการแข่งขันกิจกรรมสัมพันธ์</li>
                @endif
            </ul>
        </div>
    </div>
    <section class="forms">
        <div class="container-fluid">
            <header>
                @if ($types_of_S == "sport")
                    <h1 class="h3 display">ตารางการแข่งขันกีฬา</h1>
                @else
                    <h1 class="h3 display">ตารางการแข่งขันกิจกรรมสัมพันธ์</h1>
                @endif
            </header>
            <div class="row mb-4">
                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="h5 display">รายชื่อตารางการแข่งขันทั้งหมด</h2>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr class="bx-1">
                                    ...
                                    <td><button type="submit" name="seeD" value="seeD" class="btn btn-link text-primary">{{$sportSchedule[$i]->S_NAME_T}}<br>({{$sportSchedule[$i]->S_NAME_E}})</button></td>
                                    <td>
                                    ...
                                    <td class="bl-1">
                                        ...
                                        <div class="d-flex">
                                            <div class="mr-1">
                                                <button type="submit" name="seeD" value="seeD" class="btn btn-outline-success">ดูข้อมูลตารางการแข่งขัน</button>
                                            </div>
                                            <div class="mr-1">
                                                <button type="submit" name="updateD" value="updateD" class="btn btn-outline-info">แก้ไขข้อมูลตารางการแข่งขัน</button>
                                            </div>
                                            <div class="mr-1">
