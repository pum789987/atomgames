...
@section('title','Atom Games | แผนภูมิ')
    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li class="active"> <a href="{{Route("charts")}}"><i class="icon-presentation"></i><span>Charts</span></a></li>
                <li> <a href="{{Route("tables")}}"> <i class="icon-grid"> </i><span>Tables  </span></a></li>
...
{{ Html::script('js/charts-custom.js')}}
@endsection